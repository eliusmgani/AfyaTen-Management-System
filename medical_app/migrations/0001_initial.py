# Generated by Django 4.1.2 on 2022-12-31 12:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('billing_item', models.CharField(blank=True, max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('consultation_item', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='medical_app.item')),
                ('medical_department', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='medical_app.medicaldepartment')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('speciliaty_name', models.CharField(max_length=50, primary_key=True, serialize=False)),
            ],
        ),
        migrations.CreateModel(
            name='PriceList',
            fields=[
                ('price_list_name', models.CharField(max_length=50, primary_key=True, serialize=False)),
            ],
        ),
        migrations.CreateModel(
            name='VitalSign',
